    ...
    return {
        ...
        link: function (scope, el, attrs) {
            ...
            el.on("mousedown", function (event) {
                ...
                scope.startX = event.pageX - scope.data.width  //event.pageX;
                scope.startY = event.pageY - 0  //event.pageY;
                console.log(scope.data.x, scope.data.y, event.pageX, event.pageY);
                $document.on("mousemove", mousemove);
                $document.on("mouseup", mouseup);
            })
